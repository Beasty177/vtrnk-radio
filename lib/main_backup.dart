...
class _MyHomePageState extends State<MyHomePage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.black,
        automaticallyImplyLeading: false, // Убираем дефолтный leading
        actions: [
          IconButton(
            icon: Icon(Icons.menu, color: Colors.white, size: 36), // Увеличен на 50% (было 24)
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 15),
                    Text('Сейчас в эфире', style: TextStyle(color: Color(0xFFccc), fontSize: 14)),
                    SizedBox(height: 5),
                    Text(_artist, style: TextStyle(color: Colors.white, fontSize: 16)),
                    SizedBox(height: 2),
                    Text(_title, style: TextStyle(color: Color(0xFFddd), fontSize: 14)), // Добавлен _title
                    SizedBox(height: 10),
                    Container(
                      width: 320,
                      height: 320,
                    ...
                    SizedBox(height: 10),
                    SizedBox(
                      width: 105, // Увеличен на 50% (было 70)
                      height: 52.5, // Увеличен на 50% (было 35)
                      child: ElevatedButton(
                        ...
                        child: Icon(
                          ...
                          color: Colors.white,
                          size: 30, // Увеличен на 50% (было 20)
                        ),
                      ),
                    ),
                    SizedBox(height: 10),
