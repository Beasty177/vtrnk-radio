...
class _MyHomePageState extends State<MyHomePage> with SingleTickerProviderStateMixin {
  ...
  final int barCount = 14; // Как в HTML
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          Center(
            child: SingleChildScrollView( // Для мобильной прокрутки
              child: ConstrainedBox(
                constraints: BoxConstraints(maxWidth: 320), // Мобильная ширина
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    SizedBox(
                      height: 40, // Как в HTML
                        ...
                        builder: (context, child) {
                          return Row(
                            ...
                            children: List.generate(barCount, (index) {
                              return Container(
                                width: (200 / barCount) - 2, // Адаптивная ширина
                                height: 40 * _animations[index].value * _maxHeights[index],
                                margin: const EdgeInsets.symmetric(horizontal: 1),
                                color: Color(0xFFd3d3d3), // Как в HTML
                              );
                            }),
                          );
                        },
                    ...
                    SizedBox(height: 2),
                    Text(_title, style: TextStyle(color: Color(0xFFddd), fontSize: 14)),
                    SizedBox(height: 10),
                    Container(
                      width: 320,
                      height: 320,
